  ...
  return (
    <div className="relative min-h-screen bg-[#0A0A0A] flex items-center justify-center px-4 py-12 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-[-15%] left-[-5%] w-[450px] h-[450px] rounded-full bg-[#C6A962]/[0.04] blur-[120px]" />
        <div className="absolute bottom-[-15%] right-[-5%] w-[400px] h-[400px] rounded-full bg-[#C6A962]/[0.03] blur-[100px]" />
      </div>
      ...
      >
        ...
        >
          ...
          <motion.div variants={item} className="flex justify-center mb-6">
            <div className="w-16 h-16 rounded-full border-2 border-[#C6A962] flex items-center justify-center bg-[#C6A962]/10 shadow-[0_0_40px_rgba(198,169,98,0.15)]">
          ...
          {/* no forgot password for managers */}
        </motion.div>
